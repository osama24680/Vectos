...
export default function ReplyWidget({ title }) {
  ...
  return (
    <>
      ...
      <form
        action="#"
        ref={ctx.form_BlgDetails}
        onSubmit={ctx.sendEmail_BlogDetails}
      >
        ...
        <input type="text" className="cs_form_field_2" name="user_name" />
        <div className="cs_height_20" />
        <label className="cs_input_label cs_heading_color cs_fs_18 cs_medium">
          Your Email*
        </label>
        <input type="email" className="cs_form_field_2" name="user_email" />
